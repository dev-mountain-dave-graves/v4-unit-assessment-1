...
let me = {
  ...
  state: "Utah",
  age: 37,
  greeter: method = {return: `'Hello! My name is ${firstName} and I live in ${state}'`}
}
...
function isItBob(object, cb){
  let nameIsBob = object.name = 'Bob'
  if (nameIsBob = true)
  {
    cb(true);
  }
  else if (nameIsBob = false)
  {
    cb(false);
  }
}
